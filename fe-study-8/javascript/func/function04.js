...
//------------------------
// 콜백 함수를 매개변수로 필요로 하는기능
//setTimeout(함수,시간) -> 매개변수로 넘긴 시간이 지난후 함수를 실행
...
//functiion outCb(f){}
const outCb= (f)=>{
    console.log('outCb()함수가 수행하는 코드1');
    console.log('outCb()함수가 수행하는 코드2');
    console.log('outCb()함수가 수행하는 코드3');
    f();
}
