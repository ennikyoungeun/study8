...
//인터넷(Http)통신 ->데이터전달(주고받기)
//JSON(JavaScript Object Notation) -> 자바스크립트 객체 표기법

//자바 자료형 Map 비슷

let weather= "맑음";
//객체 object -> {key : value, key2 : value2, key3 : value3}
//key : value
let weatherInfo ={
    day : '260605',
    weather : "맑음",
...
let sopInfo2={
   ...
   menu : [
    ...
    console.log(sopInfo2.menu[0]);
    console.log(sopInfo2.menu[2].price); //잡채밥의 가격
